...
ACLOCAL = ${SHELL} /opt/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /opt/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /opt/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /opt/build-aux/missing automake-1.15
AWK = mawk
CYGPATH_W = echo
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /opt/build-aux/missing makeinfo
MKDIR_P = /bin/mkdir -p
...
install_sh = ${SHELL} /opt/build-aux/install-sh
...
CLEANFILES = $(GOBJECTS) $(GOBJECTS) $(TESTS:tests/%.scm=%.log) *.log
